...
export default function Jurusan() {
  return (
    <section id="jurusan" className="relative w-full bg-white py-20 px-6 md:px-12 select-none border-t border-gray-100 overflow-hidden">
      
      {/* Centered lines wrapper - runs from top to bottom of section and stays locked to content coordinates */}
      <div className="absolute inset-y-0 left-6 right-6 md:left-12 md:right-12 max-w-[1240px] mx-auto pointer-events-none hidden xl:block">
